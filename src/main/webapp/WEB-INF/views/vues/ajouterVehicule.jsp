...
<H1> Ajout d'une Vehicule</H1>
<form method="post" action="insererVehicule.htm">
    <div class="col-md-12 well well-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <INPUT type="text" name="rfid" value='' id="rfid" class="form-control" min="0">
            </div>
        </div>
        <div class="row" >
            <div class="col-md-12" style ="border:none; background-color:transparent; height :20px;">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <INPUT type="text" name="etat" value='' id="etat" class="form-control" min="0">
            </div>
        </div>
        <div class="row" >
            <div class="col-md-12" style ="border:none; background-color:transparent; height :20px;">
